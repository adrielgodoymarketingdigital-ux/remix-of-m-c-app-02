      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center space-y-4 mb-16 animate-fade-in">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900">
            Nunca te pierdas una{" "}
            <span className="bg-gradient-to-r from-emerald-500 to-teal-500 bg-clip-text text-transparent">
              Actualización
            </span>
          </h2>
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Notificaciones automáticas en el celular para cada venta, OS o pago — totalmente personalizables
          </p>
        </div>

        <div className="flex flex-col items-center gap-8 max-w-3xl mx-auto">
          <div className="animate-fade-in" style={{ animationDelay: "0.1s" }}>
            <PhoneMockup image={notifVendas} alt="Notificaciones de ventas y órdenes de servicio" />
          </div>
          ...
          <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-amber-50 border border-amber-200 text-amber-700 text-sm font-medium animate-fade-in" style={{ animationDelay: "0.3s" }}>
            ...
            Disponible exclusivamente en el Plan Profesional
          </div>
