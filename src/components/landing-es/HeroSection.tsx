...
import { VideoWithCover } from "@/components/landing-es/VideoWithCover";
  ...
  return (
    <div className="flex items-center gap-2 px-3 py-2 rounded-xl bg-white/10 backdrop-blur-sm border border-white/20 text-white shrink-0">
      ...
      <div className="text-left">
        <p className="text-[8px] text-white/60 leading-none">Próximamente en</p>
      ...
      <div className="relative rounded-2xl bg-gradient-to-r from-slate-900/95 via-blue-950/95 to-slate-900/95 px-5 py-3 flex items-center gap-4 flex-wrap justify-center sm:justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <p className="text-white text-sm font-semibold tracking-wide">
            Próximamente disponible en las tiendas
          </p>
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          <div className="space-y-6 md:space-y-8 animate-fade-in text-center lg:text-left -mt-8 md:-mt-16">
            ...
            <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-gradient-to-r from-red-50 to-orange-50 border border-red-200 text-red-600 text-sm font-semibold animate-pulse">
              🔥 Menos de $1 al día · ¡Descuentos en los planes por tiempo limitado!
            </div>


            {/* Headline */}
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-[1.1]">
              <span className="bg-gradient-to-r from-blue-600 via-cyan-500 to-blue-600 bg-clip-text text-transparent">Cuando las ventas bajan,</span>{" "}
              <span className="text-slate-900">la organización se vuelve ganancia.</span>
            </h1>

            {/* Subheadline */}
            <p className="text-base md:text-lg text-slate-600 leading-relaxed max-w-xl mx-auto lg:mx-0 text-center">Ese es el secreto de los grandes talleres de reparación que siguen creciendo,

saber dónde está la ganancia.
            ...
            <ul className="hidden md:block space-y-3">
              {["Ahorra 10h/semana en papeleo y hojas de cálculo", "Mira tu ganancia real por artículo vendido y servicio", "Recibos legales generados en 1 clic", "Panel con métricas en tiempo real"].
              map((feature, index) =>
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-6 pt-4 text-sm text-slate-500">
              {["24h de acceso Premium gratis", "Cancela cuando quieras", "Soporte en portugués"].map((item, index) =>
          ...
          <div className="relative animate-fade-in hidden lg:block" style={{ animationDelay: '0.2s' }}>
            ...
            <div className="relative rounded-2xl overflow-hidden border border-slate-200 shadow-2xl shadow-slate-300/50">
              <img src={dashboardImg} alt="Panel del Sistema Méc" className="w-full h-auto" />
            </div>
          </div>
        </div>
      </div>
