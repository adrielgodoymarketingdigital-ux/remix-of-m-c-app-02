      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-10">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900">
            Mira cómo es nuestro sistema{" "}
            <span className="bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent">
              por dentro
            </span>
          </h2>
          <p className="mt-4 text-slate-600 text-lg max-w-2xl mx-auto">
            Una visión completa de todo lo que tendrás acceso al empezar
          </p>
        </div>
              ...
              >
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center gap-5 px-6">
                  ...
                  <p className="text-white text-lg md:text-2xl font-extrabold text-center leading-tight max-w-md">
                    Tour completo por el <span className="text-cyan-400">Sistema Méc</span>
                  </p>
                </div>
              </button>
            )}
