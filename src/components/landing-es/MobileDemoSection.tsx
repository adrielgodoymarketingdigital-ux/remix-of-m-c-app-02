  ...
  return (
    <div className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-slate-900 border border-slate-700 text-white">
      ...
      <div className="text-left">
        <p className="text-[9px] text-slate-400 leading-none">Próximamente en</p>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="lg:hidden flex flex-col items-center text-center space-y-8">
          ...
          <p className="text-sm text-slate-600 px-2">
            Instala como app en el celular — con ícono en la pantalla de inicio, ¡sin descargar de la tienda de apps!
          </p>

          <div className="grid grid-cols-2 gap-3 w-full max-w-sm">
            {[
              { icon: Zap, text: "Acceso rápido" },
              { icon: RefreshCw, text: "Sincronización" },
              { icon: Clock, text: "Tiempo real" },
              { icon: Smartphone, text: "Instala como app" },
            ].map((item, index) => (
          ...
          <div className="flex flex-col items-center gap-3 pt-2">
            <p className="text-xs text-slate-500 font-medium uppercase tracking-wider">Próximamente en las tiendas</p>
        ...
        <div className="hidden lg:grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            ...
            <p className="text-lg text-slate-600 leading-relaxed">
              Con Méc, tienes control total de tu taller de reparación directamente desde tu celular.
              Registra dispositivos, genera órdenes de servicio y sigue tus ganancias en tiempo real.
              Además, puedes instalar Méc como una aplicación en tu celular, con ícono en la pantalla de inicio y acceso rápido — sin necesidad de descargar nada de la tienda de apps.
            </p>
            ...
            <ul className="space-y-3">
              {[
                ...
                "Instala como app directo en el celular",
              ].map((benefit, index) => (
