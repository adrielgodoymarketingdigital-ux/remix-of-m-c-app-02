...
export interface PermissoesRecursos {
  ...
  compartilhar_link_acompanhamento: boolean;
}
...
export const PERMISSOES_DEFAULT: Permissoes = {
  ...
  recursos: {
    ...
    compartilhar_link_acompanhamento: false,
  },
  dados: {
    produtos_pecas: false,
...
export const RECURSOS_LABELS: Record<keyof PermissoesRecursos, string> = {
  ...
  compartilhar_link_acompanhamento: "Compartilhar link de acompanhamento da OS com o cliente",
};
